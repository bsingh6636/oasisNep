...
import {
  login, logOutUser, register, testFunction,
} from '../controller/Admin.controller.js';
import { Auth } from '../middleware/Auth.middleare.js';
import {
  AddNewUpdates, deleteVideoByName, viewAllUpdates, viewAllWhatsNewVideo, whatsNewVideo,
...
router.post('/addWhatsNewVideo', Auth, whatsNewVideo);
router.post('/deleteWhatsNewVideo', Auth, deleteVideoByName);
